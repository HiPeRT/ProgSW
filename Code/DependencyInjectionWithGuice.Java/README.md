...
```
java.exe -cp ".\lib\aopalliance-1.0.jar;.\lib\failureaccess-1.0.3.jar;.\lib\guava-33.4.8-jre.jar;.\lib\guice-6.0.0.jar;.\lib\jakarta.inject-api-2.0.1.jar;.\lib\javax.inject-1.jar;.\bin\" diwithguice.MainClass
```